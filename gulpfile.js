process.env.ABRAIA_KEY =
  "NWFkNDhlYWE5ODAwMDAwMDpscVFQWDhENUhpb0FTM1diSHRrQTdUb1M0cGRITEx2cw=="
...
function copyImage() {
  return src("./src/assets/img/*.webp").pipe(dest("./public/img"))
}
